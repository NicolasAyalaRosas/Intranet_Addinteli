window.PLANTILLAS.escalamiento["Portabilidad"] = {
...
PortID:`,
    ...
    "Bono de Portabilidad mal aplicado - 1 DN": `Estimados, 

Solicitamos de su apoyo para validar y en su determinado caso realizar los ajustes pertinentes en el Bono de Portabilidad aplicado al DN xxxxxx.

Se ha revisado el OfferID del "paquete" adquirido, confirmando que al usuario le corresponderia el Bono de xxxxxx de Gigas, sin embargo, hasta el momento cuenta con solo xxxxxx Gb aplicados.
...
PortID: `,
    ...
    "Bono de Portabilidad mal aplicado 2 o más DN": `Estimados, 

Solicitamos de su apoyo para validar y en su determinado caso realizar los ajustes pertinentes en el Bono de Portabilidad aplicado a los DN xxxxxx.

Se ha revisado el OfferID de los "paquetes" adquiridos, confirmando que a los usuarios les corresponderia el Bono de xxxxxx de Gigas, sin embargo, hasta el momento cuentan con solo xxxxxx Gb aplicados.
